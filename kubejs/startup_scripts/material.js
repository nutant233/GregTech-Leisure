...
GTCEuStartupEvents.registry("gtceu:element", event => {
    ...
    event.create("infuscolium", 600, 600, -1, null, "If", false)
    event.create("taranium", 440, 440, -1, null, "Tn", false)
    event.create("crystalmatrix", 10000, 0, -1, null, "§b§ke§r§b✧§ke", false)
    ...
    event.create("draconiumawakened", 16000, 16000, -1, null, "*Dr*", false)
    event.create("echoite", 570, 570, -1, null, "Ec", false)
    event.create("eternity", 1000000, 1000000, -1, null, "§ce§6t§ee§ar§bn§9i§1t§5y", false)
    event.create("degenerate_rhenium", 100, 100, -1, null, "§bRe", false)
    event.create("heavy_quark_degenerate_matter", 120, 150, -1, null, "§b§ke§r§b(u₂)d§ke", false)
    event.create("quantumchromodynamically_confined_matter", 160, 200, -1, null, "§b§ke§r§b(u₂)d(c₂)s(t₂)bg§ke", false)
    ...
    event.create("ytterbium178", 70, 108, -1, null, "Yb¹⁷⁸", false)
    ...
    event.create("raw_star_matter", 10000, 10000, -1, null, "§6§kestar_matter", false)
})
