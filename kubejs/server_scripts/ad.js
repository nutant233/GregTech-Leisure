ServerEvents.recipes(event => {
    ...
    gtr.assembler("ad_astra:rocket_nose_cone")
        .itemInputs("gtceu:stainless_steel_frame", "minecraft:lightning_rod", "kubejs:ultimate_control_circuit", "gtceu:computer_monitor_cover", "2x gtceu:double_aluminium_plate")
