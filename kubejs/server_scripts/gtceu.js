...
ServerEvents.recipes((event) => {
    ...
    gtr.assembly_line("gtceu:matter_fabricator")
        ...
        .inputFluids("gtceu:soldering_alloy 1296", "gtceu:gold 1296")
    ...
    gtr.assembly_line("kubejs:time_dilation_containment_unit")
        .itemInputs("4x gtceu:naquadah_alloy_rod", "4x gtceu:degenerate_rhenium_plate", "2x gtceu:gravi_star", "2x gtceu:ruthenium_trinium_americium_neutronate_single_wire", "2x gtceu:uhv_emitter")
        .inputFluids("gtceu:mutated_living_solder 288", "gtceu:neutronium 288", "gtceu:tritanium 576")
    ...
    gtr.assembly_line("kubejs:extremely_durable_plasma_cell")
        .itemInputs("12x gtceu:neutronium_plate", "4x gtceu:neutronium_large_fluid_pipe", "2x gtceu:uxv_electric_pump", "gtceu:uxv_field_generator", "gtceu:quantumchromodynamically_confined_matter_frame", "gtceu:fusion_coil", "#gtceu:circuits/uiv")
        .inputFluids("gtceu:super_mutated_living_solder 2304", "gtceu:echoite 2592", "gtceu:taranium 1584")
    ...
    gtr.assembly_line("kubejs:dimension_injection_casing")
        ...
        .inputFluids("gtceu:degenerate_rhenium 200", "gtceu:enriched_naquadah 288")
    ...
    gtr.assembly_line("kubejs:spacetime_compression_field_generator")
        .itemInputs("kubejs:dimensionally_transcendent_casing", "kubejs:hollow_casing", "gtceu:opv_field_generator", "kubejs:microwormhole_generator", "2x gtceu:infinity_rod", "gtceu:double_starmetal_plate", "gtceu:double_quantumchromodynamically_confined_matter_plate")
    ...
    gtr.assembly_line("kubejs:manifold_oscillatory_power_cell")
        .itemInputs("32x gtceu:titansteel_single_wire", "32x gtceu:magnetic_neodymium_rod", "16x gtceu:vibranium_plate", "8x gtceu:fine_legendarium_wire", "4x kubejs:amorphous_matter", "16x gtceu:double_red_alloy_plate", "2x gtceu:degenerate_rhenium_plate")
    ...
    gtr.assembly_line("gtceu:circuit_assembly_line")
        ...
        .inputFluids("gtceu:soldering_alloy 2880", "gtceu:rose_gold 2880", "gtceu:osmium 2880")
    ...
    gtr.assembly_line("gtceu:qft_coil")
        ...
        .inputFluids("gtceu:vanadium_gallium 1296", "gtceu:gallium_arsenide 1296")
    ...
    const parts_materialas = [
        ["uhv", "1", "europium", "abyssalalloy", "uv", "zpm", "400000", "neutronium", "ruthenium_trinium_americium_neutronate", "orichalcum", "2x gtceu:gravi_star", "1"],
        ["uev", "2", "mithril", "titansteel", "uhv", "uv", "1600000", "seaborgium", "enderite", "hastelloyx_78", "4x gtceu:gravi_star", "2"]
    ]
    parts_materialas.forEach((parts_material) => {
        ...
        gtr.assembly_line("gtceu:" + parts_material[0] + "_electric_motor")
            ...
            .inputFluids("gtceu:mutated_living_solder " + 500 * parts_material[1], "gtceu:soldering_alloy " + 1000 * parts_material[1], "gtceu:lubricant " + 2000 * parts_material[1])
        ...
        gtr.assembly_line("gtceu:" + parts_material[0] + "_electric_pump")
            .itemInputs("gtceu:" + parts_material[0] + "_electric_motor",
                ...
                "2x gtceu:" + parts_material[2] + "_single_cable")
            .inputFluids("gtceu:mutated_living_solder " + 576 * parts_material[1], "gtceu:soldering_alloy " + 1152 * parts_material[1], "gtceu:lubricant " + 2000 * parts_material[1])
        ...
        gtr.assembly_line("gtceu:" + parts_material[0] + "_conveyor_module")
            .itemInputs("2x gtceu:" + parts_material[0] + "_electric_motor",
                ...
                "2x gtceu:" + parts_material[2] + "_single_cable")
            .inputFluids("gtceu:mutated_living_solder " + 576 * parts_material[1], "gtceu:soldering_alloy " + 1152 * parts_material[1], "gtceu:lubricant " + 2000 * parts_material[1], "gtceu:styrene_butadiene_rubber " + (3456 + 1152 * parts_material[1]))
        ...
        gtr.assembly_line("gtceu:" + parts_material[0] + "_emitter")
            .itemInputs("gtceu:" + parts_material[7] + "_frame",
                ...
                "32x #forge:foils/" + parts_material[3],
                "4x gtceu:" + parts_material[2] + "_single_cable")
            .inputFluids("gtceu:mutated_living_solder " + 1152 * parts_material[1], "gtceu:soldering_alloy " + 2304 * parts_material[1])
    ...
    const parts_materials = [
        ["uiv", "4", "neutronium", "adamantine", "uev", "uhv", "6400000", "adamantium", "echoite", "infuscolium", "kubejs:unstable_star", "3"],
        ["uxv", "8", "taranium", "naquadriatictaranium", "uiv", "uev", "25600000", "vibranium", "legendarium", "hastelloyk_243", "2x kubejs:unstable_star", "4"],
        ["opv", "16", "crystalmatrix", "starmetal", "uxv", "uev", "102400000", "draconium", "draconiumawakened", "vibranium", "4x kubejs:unstable_star", "5"]
    ]
    parts_materials.forEach((parts_material) => {
        ...
        gtr.assembly_line("gtceu:" + parts_material[0] + "_electric_motor")
            .itemInputs("gtceu:long_attuned_tengam_rod",
                ...
                "64x #forge:fine_wires/" + parts_material[3],
                "2x gtceu:" + parts_material[2] + "_single_cable")
            .inputFluids("gtceu:super_mutated_living_solder " + 500 * parts_material[1], "gtceu:soldering_alloy " + 1000 * parts_material[1], "gtceu:lubricant " + 2000 * parts_material[1])
            .itemOutputs("gtceu:" + parts_material[0] + "_electric_motor")
            .EUt(parts_material[6])
            .duration(600)
            .researchWithoutRecipe("1x_gtceu_" + parts_material[4] + "_electric_motor", "gtceu:data_module")
        ...
        gtr.assembly_line("gtceu:" + parts_material[0] + "_electric_pump")
            .itemInputs("gtceu:" + parts_material[0] + "_electric_motor",
                ...
                "gtceu:" + parts_material[9] + "_rotor",
                "2x gtceu:" + parts_material[2] + "_single_cable")
            .inputFluids("gtceu:super_mutated_living_solder " + 576 * parts_material[1], "gtceu:soldering_alloy " + 1152 * parts_material[1], "gtceu:lubricant " + 2000 * parts_material[1])
            .itemOutputs("gtceu:" + parts_material[0] + "_electric_pump")
            .EUt(parts_material[6])
            .duration(600)
            .researchWithoutRecipe("1x_gtceu_" + parts_material[4] + "_electric_pump", "gtceu:data_module")
        ...
        gtr.assembly_line("gtceu:" + parts_material[0] + "_conveyor_module")
            .itemInputs("2x gtceu:" + parts_material[0] + "_electric_motor",
                ...
                "4x gtceu:" + parts_material[9] + "_screw",
                "2x gtceu:" + parts_material[2] + "_single_cable")
            .inputFluids("gtceu:super_mutated_living_solder " + 576 * parts_material[1], "gtceu:soldering_alloy " + 1152 * parts_material[1], "gtceu:lubricant " + 2000 * parts_material[1], "gtceu:styrene_butadiene_rubber " + (3456 + 1152 * parts_material[1]))
            .itemOutputs("gtceu:" + parts_material[0] + "_conveyor_module")
            .EUt(parts_material[6])
            .duration(600)
            .researchWithoutRecipe("1x_gtceu_" + parts_material[4] + "_conveyor_module", "gtceu:data_module")
        ...
        gtr.assembly_line("gtceu:" + parts_material[0] + "_emitter")
            .itemInputs("gtceu:" + parts_material[7] + "_frame",
                ...
                "32x #forge:foils/" + parts_material[3],
                "4x gtceu:" + parts_material[2] + "_single_cable")
            .inputFluids("gtceu:super_mutated_living_solder " + 1152 * parts_material[1], "gtceu:soldering_alloy " + 2304 * parts_material[1])
            .itemOutputs("gtceu:" + parts_material[0] + "_emitter")
            .EUt(parts_material[6])
            .duration(600)
            .researchWithoutRecipe("1x_gtceu_" + parts_material[4] + "_emitter", "gtceu:data_module")
    ...
    gtr.assembly_line("gtceu:aggregation_device")
        .itemInputs("4x kubejs:draconium_block_charged", "64x kubejs:pm_chip", "64x kubejs:pm_chip", "8x kubejs:reinforced_echo_shard", "4x gtceu:enderite_hex_wire", "4x gtceu:uev_field_generator", "gtceu:really_max_battery", "64x gtceu:seaborgium_screw", "8x gtceu:double_seaborgium_plate")
    ...
    gtr.assembly_line("gtceu:space_elevator")
        .itemInputs("16x gtceu:gravitation_engine_unit", "8x gtceu:uv_field_generator", "8x #gtceu:circuits/uhv", "16x #gtceu:circuits/uv", "32x #gtceu:circuits/zpm", "64x #gtceu:circuits/luv", "32x gtceu:indium_tin_barium_titanium_cuprate_hex_wire", "16x gtceu:uranium_rhodium_dinaquadide_hex_wire", "8x gtceu:enriched_naquadah_trinium_europium_duranide_hex_wire", "48x gtceu:americium_huge_restrictive_item_pipe", "48x gtceu:duranium_huge_fluid_pipe", "32x gtceu:double_pikyonium_plate", "16x fgtceu:double_orichalcum_plate")
    ...
    gtr.assembly_line("gtceu:engraving_laser_plant")
        .itemInputs("8x gtceu:uv_laser_engraver", "8x gtceu:uhv_emitter", "8x gtceu:uhv_electric_piston", "8x gtceu:uhv_sensor", "8x gtceu:uhv_robot_arm", "8x gtceu:uhv_electric_pump", "8x #gtceu:circuits/uev", "32x gtceu:grisium_plate", "16x gtceu:double_titanium_carbide_plate", "16x gtceu:double_titanium_tungsten_carbide_plate")
    ...
    gtr.assembler("kubejs:infinity_coil_block")
        .itemInputs("8x gtceu:infinity_double_wire", "8x gtceu:cosmicneutronium_foil")
        .inputFluids("gtceu:starmetal 144")
    ...
    gtr.assembler_module("kubejs:scintillator")
        .itemInputs("12x gtceu:highurabilityompoundteel_screw", "12x gtceu:fine_cinobite_wire", "6x gtceu:zylon_foil", "4x gtceu:cinobite_plate", "4x gtceu:echoite_plate", "kubejs:scintillator_crystal", "kubejs:separation_electromagnet")
    ...
    gtr.assembler("gtceu:rare_earth_centrifugal")
        .itemInputs("8x gtceu:europium_plate", "16x gtceu:uhv_electric_motor", "16x gtceu:hsss_gear", "8x gtceu:long_mithril_rod", "16x gtceu:hsse_plate", "64x gtceu:fine_naquadria_wire", "4x #gtceu:circuits/uhv")
    ...
    gtr.assembler("kubejs:plasma_containment_cell")
        .itemInputs("4x gtceu:osmiridium_plate", "gtceu:uv_field_generator", "gtceu:long_naquadah_alloy_rod", "2x gtceu:fusion_glass")
    ...
    gtr.assembler("gtceu:hyper_core")
        .itemInputs("16x gtceu:highurabilityompoundteel_screw", "4x gtceu:naquadria_frame", "4x gtceu:naquadria_plate", "2x gtceu:uev_field_generator", "gtceu:uev_sensor", "gtceu:uev_emitter", "#gtceu:circuits/uev")
    ...
    gtr.assembler("kubejs:graviton_field_constraint_casing")
        .itemInputs("gtceu:draconium_frame", "kubejs:annihilation_constrainer", "4x gtceu:double_adamantium_plate")
    ...
    gtr.assembler("kubejs:laser_cooling_casing")
        .itemInputs("gtceu:hsse_frame", "kubejs:laser_cooling_unit", "2x kubejs:uhv_voltage_coil", "4x gtceu:double_zeron_100_plate")
    ...
    gtr.dimensionally_transcendent_plasma_forge("kubejs:hypercube")
        .itemInputs("12x gtceu:cosmicneutronium_rod", "12x gtceu:black_titanium_plate")
    ...
    gtr.chemical_reactor("gtceu:hydroxylammonium_sulfate_dust")
        ...
        .itemOutputs("17x gtceu:hydroxylammonium_sulfate_dust", "12x gtceu:potassium_sulfate_dust")
    ...
    gtr.precision_assembler("kubejs:optical_soc")
        ...
        .inputFluids("gtceu:mutated_living_solder 144", "gtceu:soldering_alloy 288", "gtceu:helium 100")
    ...
    gtr.assembler("kubejs:cryogenic_interface")
        .itemInputs("gtceu:double_graphene_plate", "8x gtceu:graphene_foil", "gtceu:fine_trinium_titanium_wire")
    ...
    gtr.precision_assembler("kubejs:topological_manipulator_unit")
        ...
        .inputFluids("gtceu:antineutron 10", "gtceu:neutronium 144", "gtceu:nitrogen 10000")
    ...
    gtr.assembler_module("kubejs:microwormhole_generator")
        .itemInputs("2x gtceu:zpm_emitter", "2x gtceu:enriched_naquadah_trinium_europium_duranide_single_wire", "2x gtceu:neutronium_plate", "gtceu:zpm_field_generator", "kubejs:contained_kerr_singularity", "kubejs:void_matter")
    ...
    gtr.assembler_module("kubejs:nuclear_clock")
        .itemInputs("2x gtceu:uiv_sensor", "2x kubejs:ultrashort_pulse_laser", "2x gtceu:neutronium_plate", "kubejs:scintillator", "kubejs:bose_einstein_cooling_container", "gtceu:uv_naquadria_battery", "2x gtceu:double_rhodium_plate")
    ...
    gtr.precision_assembler("kubejs:ctc_guidance_unit")
        ...
        .inputFluids("gtceu:super_mutated_living_solder 1296", "gtceu:trinium_titanium 1296", "gtceu:vibranium 1296")
    ...
    const overworld_vs =
        ...
        [["12x #forge:ores/graphite",
            "8x #forge:ores/diamond",
            "4x #forge:ores/coal"], "kubejs:diamond_vein_essence"],
    ...
    space_drones.slice(1).forEach((space_drone) => {
        space_fluid1s.forEach((space_fluid) => {
            gtr.drilling_module(space_drone + "1_space_fluid_" + space_fluid[1])
                ...
                .inputFluids("gtceu:rocket_fuel 10000")
                .outputFluids(space_fluid[0])
                .EUt(GTValues.VA[GTValues.UV] * (4 ** space_drone))
                .duration(1200 / (2 ** space_drone))
    ...
    space_drones.slice(2).forEach((space_drone) => {
        space_fluid2s.forEach((space_fluid) => {
            gtr.drilling_module(space_drone + "1_space_fluid_" + space_fluid[1])
                ...
                .inputFluids("gtceu:rocket_fuel 10000")
                .outputFluids(space_fluid[0])
                .EUt(GTValues.VA[GTValues.UHV] * (4 ** space_drone))
                .duration(1200 / (2 ** space_drone))
    ...
    gtr.dimensionally_transcendent_plasma_forge("gtceu:magnetohydrodynamicallyconstrainedstarmatter")
        ...
        .inputFluids("gtceu:raw_star_matter_plasma 1000", "gtceu:exciteddtsc 1000")
    ...
    gtr.assembler("kubejs:antimatter_charge")
        .itemInputs("16x gtceu:highurabilityompoundteel_plate", "kubejs:pellet_antimatter", "64x ae2:matter_ball", "64x minecraft:tnt", "64x gtceu:highurabilityompoundteel_bolt", "16x gtceu:uranium_rhodium_dinaquadide_plate")
    ...
    const fluids = ["argon", "helium", "nickel", "iron", "nitrogen", "oxygen", "mithril", "orichalcum", "enderium", "adamantium", "infuscolium", "echoite", "vibranium", "taranium_rich_liquid_helium_4", "legendarium", "heavy_quark_degenerate_matter", "starmetal", "quantumchromodynamically_confined_matter"]
    ...
    robots.forEach((robot) => {
        gtr.assembler("kubejs:precision_circuit_assembly_robot_mk" + robot[1])
            .itemInputs("2x gtceu:" + robot[0] + "_robot_arm", "gtceu:" + robot[0] + "_sensor", "4x #gtceu:circuits/" + robot[2], "2x gtceu:pikyonium_plate")
            .inputFluids("gtceu:soldering_alloy 1440")
    ...
    gtr.assembler("kubejs:smd_transistor_bioware")
        .itemInputs("8x gtceu:fine_naquadah_alloy_wire", "2x gtceu:germaniumtungstennitride_plate")
    ...
    gtr.assembler("kubejs:smd_capacitor_exotic")
        .itemInputs("gtceu:glowstone_plate", "2x gtceu:cinobite_foil", "2x gtceu:carbon_nanotubes_foil")
        .inputFluids("gtceu:fullerene_polymer_matrix_pulp 72")
    ...
    gtr.assembler("kubejs:smd_resistor_exotic")
        .itemInputs("4x gtceu:fine_cinobite_wire", "2x gtceu:indium_tin_barium_titanium_cuprate_foil", "2x gtceu:enderite_foil")
        .inputFluids("gtceu:fullerene_polymer_matrix_pulp 72")
    ...
    gtr.assembler("kubejs:smd_diode_exotic")
        .itemInputs("gtceu:enderite_plate", "gtceu:trinium_titanium_plate", "2x gtceu:dubnium_foil")
        .inputFluids("gtceu:fullerene_polymer_matrix_pulp 72")
    ...
    gtr.suprachronal_assembly_line("gtceu:max_electric_motor")
        ...
        .inputFluids("gtceu:super_mutated_living_solder " + 500 * 32, "gtceu:soldering_alloy " + 1000 * 32, "gtceu:lubricant " + 2000 * 32)
    ...
    gtr.suprachronal_assembly_line("gtceu:max_electric_pump")
        .itemInputs("gtceu:max_electric_motor",
            ...
            "16x gtceu:cosmicneutronium_single_cable")
        .inputFluids("gtceu:super_mutated_living_solder " + 576 * 32, "gtceu:soldering_alloy " + 1152 * 32, "gtceu:lubricant " + 2000 * 32)
    ...
    gtr.suprachronal_assembly_line("gtceu:max_conveyor_module")
        .itemInputs("2x gtceu:max_electric_motor",
            ...
            "16x gtceu:cosmicneutronium_single_cable")
        .inputFluids("gtceu:super_mutated_living_solder " + 576 * 32, "gtceu:soldering_alloy " + 1152 * 32, "gtceu:lubricant " + 2000 * 32, "gtceu:styrene_butadiene_rubber " + 1152 * (3 + 32))
    ...
    gtr.suprachronal_assembly_line("gtceu:max_emitter")
        ...
        .inputFluids("gtceu:super_mutated_living_solder " + 1152 * 32, "gtceu:soldering_alloy " + 2304 * 32)
    ...
    gtr.suprachronal_assembly_line("gtceu:max_field_generator")
        .itemInputs("gtceu:infinity_frame",
            ...
            "2x #gtceu:circuits/max",
            "64x gtceu:infinity_single_wire",
            "64x gtceu:infinity_single_wire",
            "64x gtceu:infinity_single_wire",
            "64x gtceu:infinity_single_wire",
            "32x gtceu:cosmicneutronium_single_cable")
    ...
    gtr.cosmos_simulation("cosmos_simulation1")
        ...
        .duration(1200)
        .inputFluids("gtceu:cosmic_element 4096000")
    ...
    gtr.forming_press("kubejs:exotic_ram_wafer")
        .itemInputs("kubejs:optical_ram_wafer", "gtceu:nor_memory_wafer", "gtceu:nand_memory_wafer", "gtceu:amethyst_plate")
    ...
    gtr.forming_press("kubejs:supracausal_ram_wafer")
        .itemInputs("kubejs:cosmic_ram_wafer", "kubejs:exotic_ram_wafer", "kubejs:pellet_antimatter", "gtceu:legendarium_foil")
    ...
    gtr.assembler("kubejs:dimension_connection_casing")
        .itemInputs("gtceu:draconium_frame", "kubejs:dimensional_bridge_casing", "gtceu:periodicium_block", "8x gtceu:double_mithril_plate")
    ...
    gtr.super_particle_collider("gtceu:antimatter")
        .inputFluids("gtceu:antihydrogen 2000", "gtceu:antineutron 1000")
    ...
    gtr.ultimate_material_forge("kubejs:pellet_antimatter")
        ...
        .chancedOutput("kubejs:pellet_antimatter", 8000, 0)
        .EUt(GTValues.VA[GTValues.UXV])
        .duration(2000)
    ...
    gtr.ultimate_material_forge("kubejs:corporeal_matter")
        ...
        .chancedOutput("kubejs:corporeal_matter", 9000, 0)
    ...
    gtr.ultimate_material_forge("kubejs:kinetic_matter")
        ...
        .chancedOutput("kubejs:kinetic_matter", 8000, 0)
    ...
    gtr.ultimate_material_forge("kubejs:amorphous_matter")
        ...
        .chancedOutput("kubejs:amorphous_matter", 8500, 0)
    ...
    gtr.ultimate_material_forge("kubejs:essentia_matter")
        ...
        .chancedOutput("kubejs:essentia_matter", 7000, 0)
    ...
    gtr.ultimate_material_forge("kubejs:omni_matter")
        ...
        .chancedOutput("kubejs:omni_matter", 9000, 0)
    ...
    gtr.ultimate_material_forge("kubejs:void_matter")
        ...
        .inputFluids("gtceu:uu_matter 1000", "gtceu:gluons 1000")
        .chancedOutput("kubejs:void_matter", 8000, 0)
    ...
    gtr.ultimate_material_forge("kubejs:temporal_matter")
        ...
        .chancedOutput("kubejs:temporal_matter", 6000, 0)
    ...
    gtr.ultimate_material_forge("kubejs:dark_matter")
        ...
        .inputFluids("gtceu:uu_matter 1000", "gtceu:dimensionallytranscendentcrudecatalyst 1000")
        .chancedOutput("kubejs:dark_matter", 5000, 0)
    ...
    gtr.aggregation_device("kubejs:chaotic_core")
        .notConsumable("kubejs:dragon_stabilizer_core")
        .itemInputs("gtceu:draconium_dust", "gtceu:opv_field_generator", "kubejs:chaos_shard", "gtceu:legendarium_block", "kubejs:awakened_core", "gtceu:max_field_generator", "kubejs:unstable_star", "gtceu:draconiumawakened_block")
    ...
    gtr.large_chemical_reactor("gtceu:zirconium_oxide_dust")
        ...
        .itemOutputs("18x gtceu:potassium_sulfate_dust", "3x gtceu:zirconium_oxide_dust")
    ...
    gtr.assembly_line("ad_astra_rocketed:tier_7_rocket")
        .itemInputs("ad_astra:rocket_nose_cone", "gtceu:zpm_field_generator", "16x #gtceu:circuits/uv", "4x gtceu:zpm_fluid_regulator", "4x ad_astra:calorite_tank", "ad_astra:calorite_engine", "8x ad_astra:ostrum_block", "64x ad_astra:calorite_plate", "4x ad_astra:rocket_fin")
    ...
    gtr.assembly_line("gtceu:nano_forge_3")
        .itemInputs("16x gtceu:uxv_machine_hull", "16x gtceu:draconium_nanoswarm", "16x kubejs:awakened_core", "16x gtceu:uxv_robot_arm", "16x gtceu:uxv_conveyor_module", "32x gtceu:uxv_electric_motor", "16x #gtceu:circuits/uxv", "16x gtceu:taranium_octal_wire", "kubejs:wyvern_energy_core")
        .inputFluids("gtceu:soldering_alloy 4608", "gtceu:hsss 4608", "gtceu:osmiridium 4608", "gtceu:enriched_naquadah 4608")
    ...
    gtr.nano_forge("gtceu:glowstone_nanoswarm")
        ...
        .itemInputs("64x minecraft:glowstone", "64x gtceu:soc", "32x gtceu:advanced_soc")
        .itemOutputs("64x gtceu:glowstone_nanoswarm")
        .inputFluids("gtceu:soldering_alloy 40000", "gtceu:lubricant 40000")
        .duration(60000)
        .EUt(GTValues.VA[GTValues.UV])
    ["addData(java.lang.String,int)"]("nano_forge_tier", 1)
    ...
    gtr.nano_forge("gtceu:copper_nanoswarm")
        ...
        .itemInputs("64x minecraft:copper_block", "64x gtceu:soc")
        .itemOutputs("64x gtceu:copper_nanoswarm")
        .inputFluids("gtceu:soldering_alloy 20000", "gtceu:lubricant 20000")
        .duration(40000)
        .EUt(GTValues.VA[GTValues.UV])
    ["addData(java.lang.String,int)"]("nano_forge_tier", 1)
    ...
    gtr.nano_forge("gtceu:iron_nanoswarm")
        ...
        .itemInputs("64x minecraft:iron_block", "64x gtceu:soc")
        .itemOutputs("64x gtceu:iron_nanoswarm")
        .inputFluids("gtceu:soldering_alloy 20000", "gtceu:lubricant 20000")
        .duration(40000)
        .EUt(GTValues.VA[GTValues.UV])
    ["addData(java.lang.String,int)"]("nano_forge_tier", 1)
    ...
    gtr.nano_forge("gtceu:gold_nanoswarm")
        ...
        .itemInputs("64x minecraft:gold_block", "64x gtceu:soc", "32x gtceu:advanced_soc")
        .itemOutputs("64x gtceu:gold_nanoswarm")
        .inputFluids("gtceu:soldering_alloy 60000", "gtceu:lubricant 60000")
        .duration(80000)
        .EUt(GTValues.VA[GTValues.UV])
    ["addData(java.lang.String,int)"]("nano_forge_tier", 1)
    ...
    gtr.nano_forge("gtceu:silver_nanoswarm")
        ...
        .itemInputs("64x gtceu:silver_block", "64x gtceu:soc", "32x gtceu:advanced_soc")
        .itemOutputs("64x gtceu:silver_nanoswarm")
        .inputFluids("gtceu:soldering_alloy 60000", "gtceu:lubricant 60000")
        .duration(80000)
        .EUt(GTValues.VA[GTValues.UV])
    ["addData(java.lang.String,int)"]("nano_forge_tier", 1)
    ...
    gtr.nano_forge("gtceu:neutronium_nanoswarm")
        ...
        .itemInputs("64x gtceu:neutronium_block", "64x gtceu:soc", "64x gtceu:advanced_soc", "32x gtceu:highly_advanced_soc")
        .itemOutputs("64x gtceu:neutronium_nanoswarm")
        .inputFluids("gtceu:mutated_living_solder 20000", "gtceu:soldering_alloy 80000", "gtceu:lubricant 80000")
        .duration(160000)
        .EUt(GTValues.VA[GTValues.UV])
    ["addData(java.lang.String,int)"]("nano_forge_tier", 1)
    ...
    gtr.nano_forge("gtceu:draconium_nanoswarm")
        ...
        .itemInputs("64x gtceu:draconium_block", "64x gtceu:advanced_soc", "64x gtceu:highly_advanced_soc", "32x kubejs:optical_soc", "32x kubejs:high_precision_crystal_soc")
        .itemOutputs("64x gtceu:draconium_nanoswarm")
        .inputFluids("gtceu:super_mutated_living_solder 40000", "gtceu:mutated_living_solder 40000", "gtceu:lubricant 160000")
        .duration(160000)
        .EUt(GTValues.VA[GTValues.UEV])
    ...
    gtr.nano_forge("gtceu:spacetime_nanoswarm")
        ...
        .itemInputs("64x gtceu:spacetime_block", "64x gtceu:highly_advanced_soc", "64x kubejs:optical_soc", "64x kubejs:high_precision_crystal_soc", "64x kubejs:cosmic_soc")
        .itemOutputs("64x gtceu:spacetime_nanoswarm")
        .inputFluids("gtceu:super_mutated_living_solder 80000", "gtceu:infinity 40000", "gtceu:cosmicneutronium 40000")
        .duration(80000)
        .EUt(GTValues.VA[GTValues.UXV])
    ...
    gtr.nano_forge("gtceu:eternity_nanoswarm")
        ...
        .notConsumable("64x gtceu:spacetime_nanoswarm")
        .itemInputs("64x gtceu:eternity_block", "64x kubejs:supracausal_processing_core")
        .itemOutputs("64x gtceu:eternity_nanoswarm")
        .inputFluids("gtceu:primordialmatter 320000", "gtceu:spacetime 80000", "gtceu:chaos 80000")
        .duration(160000)
        .EUt(GTValues.VA[GTValues.UXV])
    ["addData(java.lang.String,int)"]("nano_forge_tier", 3)

    gtr.electric_blast_furnace("gtceu:tellurium_oxide_dust")
        .itemInputs("2x gtceu:tellurium_dust")
        .inputFluids("gtceu:oxygen 2000")
        .itemOutputs("2x gtceu:tellurium_oxide_dust")
        .EUt(128)
        .duration(100)
        .blastFurnaceTemp(1760)
    ...
    gtr.chemical_reactor("gtceu:butane_1_4_diol")
        ...
        .itemInputs("2x gtceu:tellurium_oxide_dust")
        .inputFluids("gtceu:butane 1000")
    ...
    gtr.distort("gtceu:epoxy")
        .itemInputs("8x gtceu:phosphorus_dust", "128x gtceu:salt_dust")
        .inputFluids("minecraft:water 172000", "gtceu:oxygen 84000", "gtceu:propene 32000", "gtceu:benzene 48000")
        .itemOutputs("192x gtceu:sodium_hydroxide_dust")
        .outputFluids("gtceu:epoxy 32000", "gtceu:hydrogen 128000", "gtceu:hydrochloric_acid 32000")
    ...
    gtr.distort("gtceu:polyphenylene_sulfide")
        ...
        .inputFluids("gtceu:benzene 64000")
        .outputFluids("gtceu:polyphenylene_sulfide 96000", "gtceu:hydrogen 128000")
        .EUt(480)
        .duration(8192)
        .blastFurnaceTemp(800)
    ...
    gtr.distort("gtceu:polytetrafluoroethylene")
        ...
        .inputFluids("gtceu:fluorine 36000", "gtceu:oxygen 125000")
        .outputFluids("gtceu:polytetrafluoroethylene 36000")
        .EUt(8192)
        .duration(240)
        .blastFurnaceTemp(1800)

    gtr.distort("gtceu:platinum_dust")
        .itemInputs("1152x gtceu:platinum_group_sludge_dust", "16x gtceu:sulfur_dust")
