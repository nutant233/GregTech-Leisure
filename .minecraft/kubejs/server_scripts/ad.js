ServerEvents.recipes(event => {
    ...
    gtr.lightning_processor("gtlcore:ice_shard")
        .itemInputs("minecraft:blue_ice")
        .itemOutputs("ad_astra:ice_shard")
        .EUt(30)
        .duration(200)

    gtr.assembler("gtlcore:rocket_nose_cone")
    ...
    gtr.assembler("gtlcore:steel_tank")
    ...
    gtr.assembler("gtlcore:engine_frame")
    ...
    gtr.assembler("gtlcore:steel_engine")
    ...
    gtr.assembler("gtlcore:rocket_fin")
    ...
    gtr.electric_blast_furnace("gtlcore:steel_plate")
    ...
    gtr.electric_blast_furnace("gtlcore:desh_ingot")
    ...
    gtr.electric_blast_furnace("gtlcore:ostrum_ingot")
    ...
    gtr.assembler("gtlcore:desh_engine")
    ...
    gtr.assembler("gtlcore:desh_tank")
    ...
    gtr.assembler("gtlcore:ostrum_tank")
    ...
    gtr.assembler("gtlcore:ostrum_engine")
    ...
    gtr.assembler("gtlcore:calorite_tank")
    ...
    gtr.assembler("gtlcore:calorite_engine")
    ...
    gtr.assembly_line("gtlcore:tier_7_rocket")
